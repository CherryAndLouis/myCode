...
#查询结果数据
result_sql="SELECT fund_account,income_balance,init_date from account_income_balance where fund_account="+fund_account
...
for x in result_list:
    ...
    income_balance=x[1]
    #查询每日盈亏
    every_profitsql="SELECT * from asset where fund_account="+fund_account+" and init_date <="+str(init_date)
